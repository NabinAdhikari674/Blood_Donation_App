# Generated by Django 4.2.5 on 2023-10-01 16:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('blood_group_name', models.CharField(blank=True, max_length=20)),
                ('compatible_with', models.ManyToManyField(blank=True, to='user.blood_group')),
            ],
        ),
        migrations.AddField(
            model_name='user',
        ...
        migrations.AddField(
            model_name='user',
            name='blood_group_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.blood_group'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
